  ...
  <q-dialog ref="dialogRef" @hide="onDialogHide">
    <q-card class="q-dialog-plugin">
      <q-card-section>
        ...
        <q-input v-model="labeli" label="标签"/>
        <q-input v-model="valuei" label="价值"/>
        <q-input v-model="desci" label="简介"/>
      </q-card-section>
...
export default {
  ...
  methods: {
    onOk() {
      this.onDialogOK({value: this.valuei, desc: this.desci, label: this.labeli});
    }
  },
